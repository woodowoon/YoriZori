...
.btn-follow { width: 260px; height: 40px; border: none; border-radius: 8px; background-color: #0095f6; color: #fff; font-size: 16px; letter-spacing: 0.03em; }

.feed-subject { width: 950px; height: 80px; margin: auto; border-bottom: 1px solid #d2d2d2; }
.feed-subject > p { margin: 0; color:#333; font-size: 18px; font-weight: 600; text-align: center; height: 80px; line-height: 110px; }

.mypage .myFeed { margin: 4px 25px 50px 25px; }
.mypage .feed-list { padding: 0; }
...
.mypage .feed-list li a img { width: 100%; }
.mypage .feed-list li a:hover img { filter: brightness(70%); }
