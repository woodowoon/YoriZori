...
$(function(){
	$(".btnSendDailyLike").click(function(){
		...
		let num = "${dto.dailyNum}";
		let query = "dailyNum="+dailyNum+"&userLiked="+userLiked;
...
function listReplyAnswer(answer) {
	...
	let query = "parentreplyNum=" + parentreplyNum;
	let selector = "#listReplyAnswer" + parentreplyNum;
...
function countReplyAnswer(answer) {
	...
	const fn = function(data){
		...
		let selector = "#answerCount"+parentreplyNum;
		$(selector).html(count);
	};
...
$(function(){
	$("body").on("click", ".btnSendReplyAnswer", function(){
		...
		let replyContent = $td.find("textarea").val().trim();
		if(! content) {
		...
		let url = "${pageContext.request.contextPath}/daily/insertReply";
		let query = "dailyNum=" + dailyNum + "&replyContent=" + replyContent + "&parentreplyNum=" + parentreplyNum;
